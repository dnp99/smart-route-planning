...
export const responsiveStyles = {
  ...
  sidebar:
    "sticky top-0 hidden h-screen w-60 shrink-0 flex-col gap-7 px-4 py-6 backdrop-blur-md bg-[linear-gradient(180deg,rgba(255,255,255,0.55)_0%,rgba(241,245,249,0.5)_60%,rgba(224,238,253,0.55)_100%)] dark:bg-[linear-gradient(180deg,rgba(15,23,42,0.4)_0%,rgba(15,23,42,0.4)_60%,rgba(8,47,73,0.42)_100%)] md:flex",
  sidebarBrand:
