...
export const responsiveStyles = {
  ...
  onboardingObjectiveFieldset: "grid gap-3 rounded-xl border border-slate-200 p-4 dark:border-slate-700",
  ...
  legalLink: "text-blue-600 underline hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300",
