...
export const responsiveStyles = {
  ...
  appFooterInner:
    "mx-auto flex w-full max-w-7xl flex-col items-center gap-3 px-4 py-4 pb-[calc(1rem+env(safe-area-inset-bottom))] sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:px-6 sm:pb-4 md:pl-3 md:pr-8",
  ...
  contentWrapper: "mx-auto w-full max-w-7xl flex-1 px-4 pb-6 sm:px-6 md:pl-3 md:pr-8",
