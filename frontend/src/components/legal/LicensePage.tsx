...
export default function LicensePage({ isModal = false }: LegalPageProps) {
  return (
    <LegalPageLayout isModal={isModal} title="License" updatedAt="Last updated: March 2026">
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>1. Application License</h2>
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>2. Third-Party Software</h2>
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>3. Third-Party Services</h2>
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>4. Disclaimer</h2>
        <p className="m-0">
        ...
        <p className="m-0 mt-2">Users remain responsible for verifying schedules and decisions.</p>
      </section>

      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>5. Limitation of Liability</h2>
