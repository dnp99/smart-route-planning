    ...
    <main className="mt-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
      ...
      <div className="mt-4 grid gap-4 text-sm text-slate-700 dark:text-slate-300">
        <section>
          ...
          <p className="m-0">
            CareFlow is proprietary software. All rights are reserved by CareFlow. Unauthorized
            copying, modification, distribution, or use of this software, in whole or in part, is
        ...
        <section>
          ...
          <p className="m-0">
            CareFlow is built with open-source software. Third-party library notices and license
            attributions will be listed here. Please contact us for a complete list of open-source
