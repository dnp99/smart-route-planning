...
export default function TermsPage({ isModal = false }: LegalPageProps) {
  return (
    ...
    >
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>2. Eligibility</h2>
        <p className="m-0">
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>3. Use of the Service</h2>
        <p className="m-0">
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>4. User Accounts</h2>
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>5. Client Data</h2>
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>6. Data and Availability</h2>
        <p className="m-0">
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>7. Limitation of Liability</h2>
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>8. Intellectual Property</h2>
        <p className="m-0">
          All rights to the Routefy application, including software, design, and branding, are owned
          by Routefy.
        </p>
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>9. Termination</h2>
      ...
      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>10. Changes to the Service</h2>
        <p className="m-0">
          We may modify or update Routefy at any time, including features and functionality.
        </p>
        <p className="m-0 mt-2">
          We may also update these Terms. Continued use of the service means you accept the updated
          Terms.
        </p>
      </section>

      <section>
        <h2 className={responsiveStyles.legalSectionTitle}>11. Governing Law</h2>
        <p className="m-0">
