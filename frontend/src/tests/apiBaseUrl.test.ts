...
describe("resolveApiBaseUrl", () => {
  afterEach(() => {
    vi.unstubAllEnvs();
    delete (window as Window & { __NAVIGATE_EASY_API_BASE_URL__?: string }).__NAVIGATE_EASY_API_BASE_URL__;
  });

  it("uses environment base URL when configured", () => {
    vi.stubEnv("VITE_API_BASE_URL", " https://api.example.com/ ");
    (window as Window & { __NAVIGATE_EASY_API_BASE_URL__?: string }).__NAVIGATE_EASY_API_BASE_URL__ =
      "https://window.example.com";
