...
- Gap threshold: 30 minutes (current product behavior as of Mar 19, 2026).
...
- Acceptance criteria:
  ...
  - route result displays a break card for gaps at or above nurse-configured threshold (default 30 minutes)
