...
export const ROUTE_ADVISOR_SYSTEM = [
  ...
  "- Only cite a number that appears verbatim in the data. Never estimate, re-round, or invent a figure.",
  "- You have ONLY route-level totals (total distance, total drive time) and per-stop lateness.",
  "  You have NO leg-by-leg or stop-to-stop distances or drive times. Never state a distance or",
  "  travel time 'between' two stops, never attribute a route total to a single leg, and never",
  "  comment on routing efficiency, geography, or how 'tight' the routing is.",
